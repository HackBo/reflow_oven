...
while(1)
{
  ...
  print PLOT "plot 'data/oven_program.txt' with linespoints, ";
  #print PLOT "'oven1.log' using 2:4 t 'controlling - top' with lines, ";
  #print PLOT "'oven1.log' using 1:5 t 'bottom' with lines, ";
  print PLOT "'oven1.log' using 1:2 t 'up' with lines\n;";
